    ...
    <div id="app" v-on:mouseup="appMouseUp($event)">
        <div class="k-flexcol">
            ...
            <div id="input-row" class="k-flexrow ">
                ...
                <div id="attribution">v0.8.1 - <a href="mailto:johnw3d@gmail.com">JBW</a> - based on the <a href="https://github.com/kakao/khaiii">Kakao Hangul Analyzer III</a> and JBW's phrase parser</div>
            </div>
            <!-- input row -->
            <div class="k-flexrow">
                <table>
